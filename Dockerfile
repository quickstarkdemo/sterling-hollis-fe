...
ENV VITE_DATADOG_SESSION_SAMPLE_RATE=__VITE_DATADOG_SESSION_SAMPLE_RATE__
ENV VITE_DATADOG_REPLAY_SAMPLE_RATE=__VITE_DATADOG_REPLAY_SAMPLE_RATE__
ENV VITE_DATADOG_ENABLE_LOCAL=__VITE_DATADOG_ENABLE_LOCAL__
ENV VITE_RELEASE=__VITE_RELEASE__
ENV VITE_CLERK_PUBLISHABLE_KEY=__VITE_CLERK_PUBLISHABLE_KEY__
ENV VITE_DEMO_OBSERVABILITY_UI=__VITE_DEMO_OBSERVABILITY_UI__
